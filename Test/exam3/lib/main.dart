...
class Input {
  ...
  final String phone;
  final String email;
  const Input(this.name, this.phone, this.email);
}
...
class PageDetail extends StatelessWidget {
  const PageDetail({super.key, required this.input});
  final Input input;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('The Secound Screen'),
        ),
        body: Column(
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => PageDetail(
                                input: Input('${name.text}', '${phone.text}',
                                    '${email.text}'))));
                  }
                },
